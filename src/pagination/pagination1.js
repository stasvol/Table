...
// PaginationLink, Table } from 'reactstrap';
...
//     // this.dataSet = [...Array
//     (Math.ceil(500 + Math.random() * 500))].map(
//     //     (a, i) => "Record " + (i + 1)
//     // );
//
//     // this.pageSize = 2;
//
//     // if (this.props.data.financials && this.props
//     .data.financials.length !== 0 ) {
//
//     this.pagesCount = Math.ceil(this.props.data
//     .financials.length / this.props.pages.pageSize);
//     // }
//
//     this.state = {
//       currentPage: 0,
...
//   ({ fiscalDate, accountsPayable,
//   cashChange, cashFlow }, i) => ({
//       order: i + 1,
...
//          if (d.id === card.id) {
//            return { ...d,
//            order: this.state.currentData.order };
//          }
...
//             this.props.data.financials.length !== 0 &&
//             // (this.props.data.financials )
//             this.state.data
//
//                    .slice(
...
//               this.handleClick(e, currentPage === 0)} />
//             </PaginationItem>
//
//             <PaginationItem disabled={currentPage <= 0}>
//             <PaginationLink
